...
CSteamIRCPlugin g_SteamIRCPlugin;
EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CSteamIRCPlugin, IServerPluginCallbacks, INTERFACEVERSION_ISERVERPLUGINCALLBACKS, g_SteamIRCPlugin );
